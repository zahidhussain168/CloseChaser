      ...
      items: [
        {
          type: "transaction",
          source: "qbo",
          title: "Uncategorized charge — needs a category",
        ...
        },
        {
          type: "document",
          source: "manual",
          title: "June bank statement — account ending 4821",
          details: {},
          state: "answered",
          withFile: true,
        },
        ...
        },
        {
          ...
          state: "accepted",
          answer: "Owner draw — move to equity.",
        },
      ],
      reminders: [1, 2],
    },
    {
      ...
      items: [
        ...
        },
        {
          type: "document",
          source: "manual",
          title: "Receipt for new mats — $412",
      ...
      items: [
        {
          type: "transaction",
          source: "qbo",
          title: "Uncategorized — recurring $59.00",
          details: { amount: 59, date: "2026-06-20", payee: "SaaS vendor" },
          state: "answered",
          answer: "That's our Figma subscription — software expense.",
        },
        {
          type: "document",
          source: "manual",
